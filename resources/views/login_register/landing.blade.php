          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets_landing/img/menu/menu-item-1.png" class="glightbox"><img src="assets_landing/img/menu/menu-item-1.png" class="menu-img img-fluid" alt=""></a>
                <h4>Magnam Tiste</h4>
                <p class="ingredients">
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets_landing/img/menu/menu-item-2.png" class="glightbox"><img src="assets_landing/img/menu/menu-item-2.png" class="menu-img img-fluid" alt=""></a>
                <h4>Aut Luia</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets_landing/img/menu/menu-item-3.png" class="glightbox"><img src="assets_landing/img/menu/menu-item-3.png" class="menu-img img-fluid" alt=""></a>
                <h4>Est Eligendi</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets_landing/img/menu/menu-item-4.png" class="glightbox"><img src="assets_landing/img/menu/menu-item-4.png" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets_landing/img/menu/menu-item-5.png" class="glightbox"><img src="assets_landing/img/menu/menu-item-5.png" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets_landing/img/menu/menu-item-6.png" class="glightbox"><img src="assets_landing/img/menu/menu-item-6.png" class="menu-img img-fluid" alt=""></a>
            ...
            {{-- <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="assets_landing/img/testimonials/testimonials-2.jpg" class="img-fluid testimonial-img" alt="">
                  </div>
                </div>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="assets_landing/img/testimonials/testimonials-3.jpg" class="img-fluid testimonial-img" alt="">
                  </div>
                </div>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="assets_landing/img/testimonials/testimonials-4.jpg" class="img-fluid testimonial-img" alt="">
                  </div>
                </div>
              </div>
            </div><!-- End testimonial item --> --}}
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              <div class="member-img">
                <img src="assets_landing/img/chefs/chefs-1.jpg" class="img-fluid" alt="">
                <div class="social">
          ...
          <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="assets_landing/img/chefs/chefs-2.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member">
              <div class="member-img">
                <img src="assets_landing/img/chefs/chefs-3.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
    ...
    {{-- <section id="book-a-table" class="book-a-table section">
      ...
      <div class="container">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 reservation-img" style="background-image: url(assets_landing/img/reservation.jpg);"></div>
